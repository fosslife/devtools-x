export const templates: {
  ...
  autoGen: `<!-- This is an autogenerated message. Please do not edit this file. -->
`,
  acknowledgements: `
## Acknowledgements
...
`,
  logo: `
![Logo](https://github.com/fosslife/devtools-x/raw/master/assets/banner.png)    
  `,
  optimizations: `  
## Optimizations
...
![App Screenshots](https://via.placeholder.com/468x300?text=Place+your+screenshots+here)
`,
  support: `
## Support
